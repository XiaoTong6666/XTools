...
template <bool... Booleans> struct cxpr_or_impl : std::false_type {};
...
template <bool... Booleans> struct cxpr_and_impl : std::true_type {};
...
template <bool... Booleans> struct cxpr_or_c : cxpr_or_impl<Booleans...> {};

template <class... Booleans>
struct cxpr_and : cxpr_and_impl<Booleans::value...> {};

template <bool... Booleans> struct cxpr_and_c : cxpr_and_impl<Booleans...> {};
